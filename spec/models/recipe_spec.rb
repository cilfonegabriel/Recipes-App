...
RSpec.describe Recipe, type: :model do
  ...
  it 'preparation time should be a time type' do
    expect(subject.preparation_time).to be_an(Time)
  end
  ...
  it 'cooking time should be a time type' do
    expect(subject.cooking_time).to be_an(Time)
  end
